...
const caps = {
  ...
  'browserstack.username': process.env.BROWSERSTACK_USERNAME || 'ramkumark_0jJKNR',
  'browserstack.accessKey': process.env.BROWSERSTACK_ACCESS_KEY || 'biBRXrQ3xxFBPexj7yzY',
...
exports.BS_LOCAL_ARGS = {
  key: process.env.BROWSERSTACK_ACCESS_KEY || 'biBRXrQ3xxFBPexj7yzY',
};
